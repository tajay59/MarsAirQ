...
<script setup>
   ...
   import  'highcharts/highcharts-more';
    ...
    watch(payload,(msg)=> {          
        ...
        if(msg.type == "station" && params.value.includes('windspeed')){    
            ...
            chart.value.series[0].addPoint({y:parseFloat(msg.data.windspeed.toFixed(2)) ,x: msg.timestamp * 1000 }, true, shift.value);   
        }          
    });
    ...
    chart.value = Highcharts.chart('container', {
        ...
        subtitle: { text: 'Wind Speed', align: 'center' },
        yAxis: { 
