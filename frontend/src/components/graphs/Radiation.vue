...
<script setup>
   ...
   import  'highcharts/highcharts-more';
    ...
    watch(payload,(msg)=> {          
        ...
        if(msg.type == "station" && params.value.includes('radiation')){    
            ...
            chart.value.series[0].addPoint({y:parseFloat(msg.data.radiation.toFixed(2)) ,x: msg.timestamp * 1000 }, true, shift.value);   
        }          
    });
    ...
    chart.value = Highcharts.chart('container', {
        ...
        subtitle: { text: 'Radiation', align: 'center' },
        yAxis: { 
            title:null,// title: { text: 'Radiation' , style:{color:'#000000'}},
            labels: { format: '{value} W/m^2' },   
            // max:50,
            // min:10        
        },
