...
<script setup>
   ...
   import  'highcharts/highcharts-more';
    ...
    watch(payload,(msg)=> {          
        ...
        if(msg.type == "station" && params.value.includes('rainfall')){    
            ...
            chart.value.series[0].addPoint({y:parseFloat(msg.data.rainfall.toFixed(2)) ,x: msg.timestamp * 1000 }, true, shift.value);   
        }          
    });
    ...
    chart.value = Highcharts.chart('container', {
        ...
        subtitle: { text: 'Precipitation', align: 'center' },
        yAxis: { 
            title:null,// title: { text: 'Precipitation' , style:{color:'#000000'}},
