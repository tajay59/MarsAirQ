...
class MQTT:
    ...
    sub_topics = [("/devices", 0), ("620012345", 0), ("/station/data/#", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.username_pw_set("cimh","#Blackops")
